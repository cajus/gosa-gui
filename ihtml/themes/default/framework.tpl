  <body>
   ...
   <div class='title-bar'>
    <ul>
     ...
     <li class='right table-wrapper'>
       <div class='logout-label'>
         <form action='logout.php' name='logoutframe' method='post' enctype='multipart/form-data'>
          <div style='cursor:pointer' title='{tr}Log out{/tr}' onClick="
                    return question('{tr}You are currently editing a database entry. Do you want to dismiss the changes?{/tr}',
     ...
     <li class='right table-wrapper'>
       <div class='logout-label'>
        <canvas id="sTimeout" width="22" height="22" title="{$sessionLifetime}|{tr}Session expires in %d!{/tr}"></canvas>
       </div>
     </li>
    </ul>
   </div>
