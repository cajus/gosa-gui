  ...
  <table summary="" style="width:99%;">
   <tr>
	...
	<td style="text-align:right;">
	 <input type='text' name="search_string" size="15" value="{$search_string}" maxlength="50">&nbsp;<button type='submit' name='search'>{tr}Search{/tr}</button>
