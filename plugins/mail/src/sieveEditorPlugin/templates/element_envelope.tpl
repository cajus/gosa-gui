    ...
    {if $Expert}
        {if $LastError != ""}
		<table width='100%' class='sieve_test_case'  summary="{tr}Sieve envelope{/tr}">
            <tr>
                <td colspan=2>
...
<table width='100%' summary="{tr}Sieve element{/tr}">
    <tr>
        ...
        <td>
            {if $Inverse}
                <button type='submit' name='toggle_inverse_{$ID}' title="{tr}Inverse match{/tr}">{tr}Yes{/tr}</button>

            {else}
                <button type='submit' name='toggle_inverse_{$ID}' title="{tr}Inverse match{/tr}">{tr}No{/tr}</button>
...
<table style='width:100%;' summary="{tr}Sieve envelope{/tr}"> 
    <tr>
        <td >
