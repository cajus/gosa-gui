<p class="contentboxh" style="font-size:12px">
  <b>{tr}List of SSH public keys for this user{/tr}</b><br>
</p>
...
&nbsp;
<button type='submit' name='upload_sshpublickey'>{tr}Upload key{/tr}</button>

&nbsp;
<button type='submit' name='remove_sshpublickey'>{tr}Remove key{/tr}</button>
