...
<div id="mainlist">
  ...
  <div class="mainlist-nav">
   <table summary="{tr}Filter{/tr}" style="width: 100%;" 
    ...
    <tr>
     ...
     <td colspan="2" style='width:25%;'>{tr}Host{/tr}:
 ...
 {else}
  ...
  <div class="listContainer" id="d_scrollbody" style="min-height: 475px; height: 444px;">
   ...
   <table summary="{tr}Entry list{/tr}" style="width:100%;" cellpadding="0" cellspacing="0">
    <thead class="fixedListHeader listHeaderFormat">
     <tr>
      <td class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=DeviceReportedTime'>{tr}Date{/tr}</a>      
      ...
      <td  class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=FromHost'>{tr}Source{/tr}</a>
      ...
      <td class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=SysLogTag'>{tr}Header{/tr}</a>
      ...
      <td class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=Facility'>{tr}Facility{/tr}</a>
      ...
      <td class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=Priority'>{tr}Severity{/tr}</a>
      ...
      <td class='listheader'>
       <a href='?plug={$plug_id}&amp;sort_value=Message'>{tr}Message{/tr}</a>
