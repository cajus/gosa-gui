  ...
  <div>
   ...
   <div style='padding-left: 25px;'>
     {tr}User must change password on first login{/tr}
   </div>
  </div>
  ...
  <div>
   ...
   <div style='padding-left: 25px;'>
    ...
    <table summary="{tr}Password expiration settings{/tr}" border="0" cellpadding="0" cellspacing="0">
     <tr>
      <td>
       {tr}Password expires on{/tr}&nbsp;
      </td>
