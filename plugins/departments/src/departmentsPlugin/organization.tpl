<!--////////////////////
	//	ORGANIZATION (o)
    //////////////////// -->
<table summary="{tr}Organization{/tr}" style="width:100%" cellpadding=4>
 <tr>
   <td style="width:50%">
     ...
     <table summary="{tr}Properties{/tr}">
      <tr>
       <td><LABEL for="o">{tr}Name of organization{/tr}</LABEL>{$must}</td>
       <td>
{render acl=$oACL}
	<input type='text' id="o" name="o" size=25 maxlength=60 value="{$o}" title="{tr}Name of organization to create{/tr}">
{/render}
       </td>
      </tr>
      <tr>
