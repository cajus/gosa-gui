 ...
 *
 * ID: $$Id: getfax.php 17460 2010-04-01 13:12:08Z hickert $$
 *
...
$link = mysql_pconnect($cfg['SERVER'], $cfg['LOGIN'], $cfg['PASSWORD'])
                  or die(tr("Could not connect to database server!"));

mysql_select_db("gofax") or die(tr("Could not select database!"));


/* Permission to view? */
$query = "SELECT id,uid FROM faxlog WHERE id = '".validate(stripcslashes($_GET['id']))."'";
$result = mysql_query($query) or die(tr("Database query failed!"));
